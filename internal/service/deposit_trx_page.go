...
func EXTRACT_PREV_DEPOSIT_TRX_PAGE(callbackQuery *tgbotapi.CallbackQuery, db *gorm.DB, bot *tgbotapi.BotAPI) (*DepositState, bool) {
...
func ExtracNextDepositTrxPage(callbackQuery *tgbotapi.CallbackQuery, db *gorm.DB, bot *tgbotapi.BotAPI) bool {
	state := DepositStates[callbackQuery.Message.Chat.ID]
	if state == nil {
